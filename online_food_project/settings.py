"""
Django settings for online_food_project project.
...
SECRET_KEY = 'django-insecure--a7t*!w2r^t@9953(_hd%dexz)0%tijj5=5uy4t9n*+c=do*w('
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Online Food Ordering Admin",
    "site_brand": "FoodOrder",
    "welcome_sign": "Welcome to Food Admin Panel",
    "copyright": "FoodOrder",
}

# Razorpay credentials - prefer setting these via environment variables for safety
